<x-layout>
    ...
    <div class="page-header align-items-start min-vh-100">
      ...
      <div class="container mt-2">
        <div class="row">
            <h5 class="text-center mb-3">Edit Admin</h5>
          <div class="col-lg-8 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-body mt-2">
                <form class="text-start p-2" action="/admin/addAdmin/{{$admin->id}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="input-group input-group-static is-invalid mb-4">
                      ...
                      @if($admin->profile != "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png")
                          <img src="/storage/{{$admin->profile}}" height="100" width="100" class="rounded mt-3">
                      @endif
                    </div>
                    <div class="input-group input-group-static is-invalid mb-4">
